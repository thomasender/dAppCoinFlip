...
var contractAddress = "0x9DDc585AEd11a0cF04730A4542715B08536b40Bf";
...
function placeBet(){
  ...
  function getRoundResult(){
      contractInstance.events.CoinFlipped(function(err, result){
        document.getElementById("result_output").value = JSON.stringify(result.returnValues.result);
      })
    }
...
function withdrawContractBalance(){
  contractInstance.methods.withdraw().send().then(getBalance);
};
